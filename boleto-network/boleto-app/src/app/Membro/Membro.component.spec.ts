...
describe('MembroComponent', () => {
  ...
  let mockMembroService;
  let mockDataService

  beforeEach(async(() => {

    mockMembroService = sinon.createStubInstance(MembroService);
    mockMembroService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: MembroService, useValue: mockMembroService },
